...
export default function Booking() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Construct customized WhatsApp message before resetting form
...
• *Project Details:* ${formData.projectDetails}`;
      ...
      const targetWaNumber = "919691529501";
            ...
            <AnimatePresence mode="wait">
              {!isSuccess ? (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 items-center justify-center w-full max-w-md pt-2">
                    {whatsappUrl && (
                      <a
                        href={whatsappUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full sm:w-auto px-6 py-3 bg-emerald-500 text-white text-sm font-bold rounded-full flex items-center justify-center gap-2 hover:bg-emerald-600 transition-colors shadow-md shadow-emerald-500/10 cursor-pointer"
                      >
                        <svg
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full sm:w-auto px-6 py-3 bg-brand-dark text-white text-sm font-medium rounded-full cursor-pointer hover:bg-brand-dark/90 transition-colors"
                    >
